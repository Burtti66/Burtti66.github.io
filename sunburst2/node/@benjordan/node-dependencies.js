...
This variant of a [sunburst diagram](/@d3/sunburst) is for custom display of Atomist's drift report node dependencies.`
)});
  main.variable(observer("chart")).define("chart", ["partition","data","d3","width","color","arc","format","radius"], function(partition,data,d3,width,color,arc,format,radius)
{
  ...
  const path = g.append("g")
    ...
    .join("path")
      ...
      .attr("fill-opacity", d => arcVisible(d.current) ? (d.children ? 1 : 0.75) : 0)
  ...
  function clicked(p) {
    ...
    path.transition(t)
      ...
      .filter(function(d) {
        ...
        .attr("fill-opacity", d => arcVisible(d.target) ? (d.children ? 1 : 0.75) : 0)
...
d3.json("https://gist.githubusercontent.com/benjordan/f1306ba4a31e42d557dadcc9a312c93c/raw/83d1a3ad1a414c3f56809df7e0506190e87e76df/new-drift-data.json")
)});
...
d3.scaleOrdinal(d3.quantize(d3.interpolateRainbow, data.children.length + 1))
  .range(["#2ab27b", "#78aaff", "#f08955", "#b43f4d"])
)});
